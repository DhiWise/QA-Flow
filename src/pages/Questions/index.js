...
import { getUsersdetails, getQuestionsofUser } from "service/api";
      ...
      >
        ...
        >
          <Row
            ...
            comptype="Row"
          >
            <Column className="w-[70%]" compid="7:3961" comptype="Column">
              <Text
          ...
          >
            <Column
              className="items-center mt-[2px] w-[63%]"
              compid="216"
              comptype="Column"
            >
              <Text
              ...
              <Line
                className="bg-yellow_900 h-[2px] lg:mt-[10px] xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[15px] w-[80%]"
                compid="7:3966"
                comptype="Line"
              />
            </Column>
            <Text
              className="common-pointer not-italic text-bluegray_400 w-[auto]"
              compid="7:3968"
              as="h2"
              variant="h2"
              comptype="Text"
              ...
              : apiData?.items?.map((user) =>
                  apiData?.items?.length > 1
                    ? userName === user?.display_name &&
                      `These are the Questions asked by "${user?.display_name}".`
                    : `These are the Questions asked by "${user?.display_name}".`
                )}
          </Text>
          <Grid
            ...
            comptype="Grid"
          >
            {apiData1?.items?.map((apiData1ItemsEle, index) => {
              return (
                <React.Fragment key={`apiData1ItemsEle${index}`}>
                  ...
                  >
                    ...
                    >
                      ...
                      <Text
                        className="lg:ml-[275px] xl:ml-[255px] 2xl:ml-[354px] 3xl:ml-[425px] my-[1px] not-italic text-bluegray_700 w-[auto]"
                        compid="7:3981"
                        as="h4"
                        variant="h4"
                        comptype="Text"
                    ...
                    <Text
                      className="lg:mt-[17px] xl:mt-[20px] 2xl:mt-[23px] 3xl:mt-[27px] not-italic text-bluegray_700 w-[auto]"
                      compid="7:3995"
                      as="h4"
                      variant="h4"
                      comptype="Text"
